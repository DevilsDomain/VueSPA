...
import { R as T, r as d } from './index-e0023ec7.js';
import { s as P } from './index-e51aae5b.js';
import './index-73814c06.js';
import './index-3121cc12.js';
import { j as y, a as G } from './jsx-runtime-c8b955b8.js';
var X, q;
function E(a, r, e) {
  return (
    r in a
      ...
      c = d.useMemo(
        function () {
          ...
          function O(m) {
            var h = l.current,
              g = cr(t.current),
              p = m ? g.addEventListener : g.removeEventListener;
            p(h ? 'touchmove' : 'mousemove', k),
              p(h ? 'touchend' : 'mouseup', C);
          }
          return [
            function (m) {
              var h = m.nativeEvent,
              ...
              if (
                ...
                if (A(h)) {
                  ...
                  p.length && (u.current = p[0].identifier);
                }
                g.focus(), o(mr(g, h, u.current)), O(!0);
              }
            },
            function (m) {
...
function Lr(a, r, e) {
  ...
  var l = d.useCallback(function (c) {
    i(function (v) {
...
var ue = typeof window < 'u' ? d.useLayoutEffect : d.useEffect,
  le = function () {
  ...
  W = be,
  Xr = {};
for (var tr = 0, xr = Object.keys(W); tr < xr.length; tr++) {
  var kr = xr[tr];
  Xr[W[kr]] = kr;
}
var s = {
...
function Qe(a, r, e) {
  ...
  function k(x) {
    var N = n,
      F = t;
    return (n = t = void 0), (c = x), (i = a.apply(F, N)), i;
  }
  function C(x) {
...
var Y = Object.values(b),
  da = /\(([0-9]+),\s*([0-9]+)%?,\s*([0-9]+)%?,?\s*([0-9.]+)?\)/,
  ga = /^\s*rgba?\(([0-9]+),\s*([0-9]+),\s*([0-9]+),?\s*([0-9.]+)?\)\s*$/i,
  pa = /^\s*hsla?\(([0-9]+),\s*([0-9]+)%,\s*([0-9]+)%,?\s*([0-9.]+)?\)\s*$/i,
  fr = /^\s*#?([0-9a-f]{3}|[0-9a-f]{6})\s*$/i,
  ba = /^\s*#?([0-9a-f]{3})\s*$/i,
  ma = ((X = {}), E(X, b.HEX, ve), E(X, b.RGB, pe), E(X, b.HSL, de), X),
  J =
    ((q = {}),
    ...
    if (r) {
      ...
      if (pa.test(r)) {
        ...
        return (
          ...
          E(m, b.HSL, r),
          E(m, b.HEX, '#'.concat(R.hsl.hex([p, M, S]).toLowerCase())),
          m
        );
      }
      var U = r.replace('#', ''),
  ...
  ya = function (r, e, n) {
    ...
    if (n !== b.HEX) return (e == null ? void 0 : e[n]) || J[n];
    if (!e.hex.startsWith('#'))
      try {
    ...
    if (!t) return fr.test(e.hex) ? e.hex : J.hex;
    var o = t[1].split(''),
      i = H(o, 3),
      u = i[0],
      l = i[1],
  ...
  wa = function (r, e) {
    var n = d.useState(r || ''),
      ...
      o = t[0],
      i = t[1],
      u = d.useState(function () {
        return V(o);
      }),
      l = H(u, 2),
      c = l[0],
      v = l[1],
      f = d.useState((c == null ? void 0 : c.colorSpace) || b.HEX),
      w = H(f, 2),
      k = w[0],
      C = w[1];
    d.useEffect(
    ...
    var O = d.useMemo(
      ...
      m = d.useCallback(
        function (g) {
          var p = V(g);
          i((p == null ? void 0 : p.value) || g || ''),
            p && (v(p), C(p.colorSpace), e(p.value));
        },
        [e],
      ),
      h = d.useCallback(
        function () {
          var g = Y.indexOf(k) + 1;
          g >= Y.length && (g = 0), C(Y[g]);
          var p = (c == null ? void 0 : c[Y[g]]) || '';
          i(p), e(p);
        },
        [c, k, e],
      );
  ...
  xa = function (r, e, n) {
    var t = d.useState(e != null && e.valid ? [e] : []),
      o = H(t, 2),
      i = o[0],
      u = o[1];
    d.useEffect(
...
//# sourceMappingURL=Color-f953d088-a94e3ca6.js.map
