...
import { c as t, A as l, M as p } from './Props-65c0891f.js';
...
const m = '/storybook/assets/code-brackets-9ef6443e.svg',
  c = '/storybook/assets/colors-ac9401f3.svg',
  d = '/storybook/assets/comments-f15a6837.svg',
  g = '/storybook/assets/direction-94a9917f.svg',
  u = '/storybook/assets/flow-275142c6.svg',
  h = '/storybook/assets/plugin-57148314.svg',
  b = '/storybook/assets/repo-fb4ece47.svg',
  k = '/storybook/assets/stackalt-2ad81543.svg';
function n() {
  return (
    (n = Object.assign
      ? Object.assign.bind()
...
const f = {},
  y = 'wrapper';
function i({ components: s, ...o }) {
  return t(
    y,
    n({}, f, o, { components: s, mdxType: 'MDXLayout' }),
    t(p, { title: 'Example/Introduction', mdxType: 'Meta' }),
    t(
      'style',
      null,
      `
...
e.parameters.docs = {
  ...(e.parameters.docs || {}),
  page: () =>
    t(l, { mdxStoryNameToKey: w, mdxComponentAnnotations: e }, t(i, null)),
};
const z = ['__page'];
export { z as __namedExportsOrder, x as __page, e as default };
//# sourceMappingURL=Introduction.stories-895cf0a6.js.map
